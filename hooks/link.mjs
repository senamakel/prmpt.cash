...
import { normalizeCode, validateCode } from './lib/install-code.mjs';

// The code alphabet and shape checks live in lib/install-code.mjs so bin/prmpt.mjs
// can reuse them without importing this file, which runs a program on import.
// Re-exported here because the tests -- and anyone who found them here first --
// import them from this module.
export { normalizeCode, validateCode } from './lib/install-code.mjs';
